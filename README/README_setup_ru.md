...
2. **Установка FramePack-eichi**:
   ...
   - Скопируйте соответствующий языковой пакетный файл (`run_endframe_ichi.bat` для японского, `run_endframe_ichi_en.bat` для английского, `run_endframe_ichi_zh-tw.bat` для традиционного китайского) в корневую директорию FramePack
