...
## 🌟 Новые функции FramePack-oichi (v1.9.2)
...
## 🌟 Новые функции F1-модели (v1.9.1)
...
- **Многоязычная поддержка (i18n)**: Поддержка UI на японском, английском, традиционном китайском и русском языках ※русский добавлен в v2.0
...
## 📝 Информация о последнем обновлении (v1.9.2)
...
3. Запустите исполняемый файл нужной версии и языка, чтобы запустить соответствующий WebUI:
   ...
   - Обычная версия/русский: `run_endframe_ichi_ru.bat`
   ...
   - Версия F1/русский: `run_endframe_ichi_f1_ru.bat`
...
※ Многоязычные версии README также планируются постепенно. Для версии на традиционном китайском см. [README/README_zh.md](README_zh.md).
